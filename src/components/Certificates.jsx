            ...
            <div className="certificates__card flex-col">
                ...
                <div className="certificate__item flex-row">
                    ...
                    <div className="certificate__info flex-col">
                        ...
                        <p className="certificate__title"> <a href="https://www.iscedouro.pt/pt/Oferta-formativa/1-%C2%BA-Ciclo-Licenciaturas/Producao-de-Conteudos-Interativos-e-Multimedia/" target="_blank" rel="noreferrer">Interactive Multimedia Content Creation</a></p>
                ...
                <div className="certificate__item flex-row">
                    ...
                    <div className="certificate__info flex-col">
                        ...
                        <p className="certificate__title"><a href="https://www.freecodecamp.org/certification/hitmaizer/responsive-web-design" target="_blank" rel="noreferrer">Responsive Web Design</a></p>
                ...
                <div className="certificate__item flex-row">
                    ...
                    <div className="certificate__info flex-col">
                        ...
                        <p className="certificate__title"> <a href="https://devchallenges.io/certificates/FAn2CzkmrfG7oRcfTZWE" target="_blank" rel="noreferrer">Responsive Web Developer</a></p>
